...
function DaGiao({navigation , itemId}){
            ...
            <View style={{backgroundColor: '#fff7f3',  paddingBottom: 20,}}>
                ...
                <ScrollView horizontal={true} style={{flexDirection: 'row',flex: 1, width: 500, height: 50}}>
                    ...
                    <TouchableOpacity onPress={()=>{navigation.navigate('ChoGiaoHang')}} style={{paddingHorizontal: 5}}>
                        <Text style={{fontSize: 17, paddingRight: 15, fontWeight: 'bold'}}>Chờ giao hàng</Text>
                    </TouchableOpacity>
                    <View  onPress={()=>{navigation.navigate('DaGiao')}} style={{paddingHorizontal: 5}}>
                        <Text style={{fontSize: 17, paddingRight: 15,color: 'red',}}>Đã giao</Text>
                    </View>
                    <View style={{}}>
