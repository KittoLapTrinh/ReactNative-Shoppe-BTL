...
function DanhGia({navigation , itemId}){
        ...
        <View style={styles.container}>
            <View style={{backgroundColor: '#fff7f3',  paddingBottom: 20,}}>
                <View style={{flexDirection: 'row', 
                    ...
                    <Text style={{fontSize: 25, fontWeight: 'bold', justifyContent: 'center', alignItems: 'center', marginHorizontal: 30}}>Đánh giá của tôi</Text>
                ...
                <ScrollView horizontal={true} style={{flexDirection: 'row',flex: 1, width: 500, height: 50}}>
                    ...
                    <TouchableOpacity onPress={()=>{navigation.navigate('ChoXacNhan')}} style={{paddingHorizontal: 5}}>
                        <Text style={{fontSize: 17, paddingRight: 15, color: 'red',  }}>Chưa đánh giá</Text>
                    </TouchableOpacity>
                    
                    <TouchableOpacity onPress={()=>{navigation.navigate('ChoLayHang')}} style={{paddingHorizontal: 5}}>
                        <Text style={{fontSize: 17, paddingRight: 15,}}>Đã đánh giá</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>{navigation.navigate('ChoGiaoHang')}} style={{paddingHorizontal: 5}}>
                        <Text style={{fontSize: 17, paddingRight: 15, }}>Đánh giá từ người khác</Text>
                    </TouchableOpacity>
            ...
            <ScrollView style={{}}>
                <View style={{ backgroundColor: '#e0e0e0', alignItems: 'center', justifyContent: 'center', height: 300}}>
                    ...
                    <Text style={{color: '#787878'}}>Chưa có đánh giá nào</Text>
                </View>
